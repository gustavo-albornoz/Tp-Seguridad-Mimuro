...
--
-- Table structure for table `limites_mensajes`
--

DROP TABLE IF EXISTS `limites_mensajes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `limites_mensajes` (
  `mensajes` varchar(30) NOT NULL,
  `cantidad_limite` int(11) NOT NULL,
  PRIMARY KEY (`mensajes`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `limites_mensajes`
--

LOCK TABLES `limites_mensajes` WRITE;
/*!40000 ALTER TABLE `limites_mensajes` DISABLE KEYS */;
INSERT INTO `limites_mensajes` VALUES ('mensajes privados',10);
/*!40000 ALTER TABLE `limites_mensajes` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `enviarmensajes`(IN msj varchar(60),IN idem INT(11),IN idrec INT(11), IN privacidad INT(1))
BEGIN

INSERT INTO `mensajes`.`mensaje` (`mensaje`, `idemisor`, `idreceptor`, `privacidad`) VALUES (msj, idem, idrec, privacidad);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `enviarmensajesprivados` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `enviarmensajesprivados`(IN msj varchar(60),IN idem INT(11),IN idrec INT(11))
BEGIN

INSERT INTO `mensajes`.`mensajes_privados` (`mensaje`, `idemisor`, `idreceptor`) VALUES (msj, idem, idrec);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `limitemensajesprivados` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `limitemensajesprivados`()
BEGIN

SELECT cantidad_limite FROM mensajes.limites_mensajes where mensajes = 'mensajes privados';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `mensajes`(IN perf varchar(60), IN privacidad int(1))
BEGIN

SELECT usuario.nombre,usuario.apellido,mensaje.mensaje 
FROM usuario
LEFT JOIN mensaje ON usuario.idusuario=mensaje.idemisor
WHERE mensaje.idreceptor=perf AND mensaje.privacidad=privacidad;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `mensajesprivados` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `mensajesprivados`(IN perf varchar(60))
BEGIN

SELECT usuario.nombre,usuario.apellido, mensajes_privados.mensaje 
FROM usuario
LEFT JOIN mensajes_privados ON usuario.idusuario=mensajes_privados.idemisor
WHERE mensajes_privados.idreceptor=perf;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updt_limite_msjs_priv` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `updt_limite_msjs_priv`(IN cantidad int(11))
BEGIN

UPDATE mensajes.limites_mensajes SET cantidad_limite = cantidad WHERE mensajes = "mensajes privados";
...
-- Dump completed on 2015-09-21  0:02:51
