...
--
-- Host: 127.0.0.1    Database: mensajes
-- ------------------------------------------------------
...
INSERT INTO `seguidor` VALUES (1,'2'),(1,'3'),(1,'5'),(1,'9'),(2,'3'),(2,'4'),(3,'4'),(3,'9'),(4,'2'),(4,'5'),(10,'9');
...
CREATE TABLE `usuario` (
  ...
  `opcmensajes` int(11) unsigned NOT NULL DEFAULT '1',
...
INSERT INTO `usuario` VALUES (1,'Administador','Administrador','administrador@unlam.edu.ar','administrador','123456',1,1,1),(2,'Walter','White','wwhite@bb.com','I am the danger','1234567',0,1,1),(3,'Pilar','Paradela','pilar@unlam.edu.ar','Pilar','12345678',0,1,5),(4,'Jesse','Pinkman','jesse@bb.com','Mucho loco','124556',0,3,1),(5,'Saul','Goodman','saul@bb.com','Better Call Saul','1234567',0,3,1),(9,'Skyler','White','skyler@bb.com','','12345678',0,1,1),(10,'patricio','lopez','patricio@unlam.edu.ar',NULL,'123456789',0,2,1),(13,'Usuario','Anonimo','anonimo','anonimo','0',0,3,1),(14,'Ernesto','Lopez','ernesto@unlam.edu.ar',NULL,'123456',0,5,1);
...
INSERT INTO `usuario_alta` VALUES (105,'Jimi','Gato','pic@pic.com','123456789'),(109,'Homero','Simpson','homero@unlam.edu.ar','123456789'),(110,'Jose','Perez','Jose@unlam.edu.ar','12345678');
...
/*!50003 DROP PROCEDURE IF EXISTS `cant_msj` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `cant_msj`(IN idusr int(11), IN opcion int(11))
BEGIN

UPDATE `mensajes`.`usuario` SET `opcmensajes`= opcion WHERE `idusuario`=idusr;
...
-- Dump completed on 2015-09-21 11:45:53
